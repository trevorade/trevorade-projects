    ...
    if (qName.equals("quest")) {
      ...
      if (!org.lightless.heroscribe.Constants.version.equals(attrs
        ...
        throw new SAXException(
            "Heroscribe's and quest's version numbers don't match.");
      ...
      board = new QBoard(objects.getBoard().width, objects.getBoard().height,
          quest);
      ...
      if (left + width - 1 > objects.getBoard().width || left < 1
          || top + height - 1 > objects.getBoard().height || top < 1)
